<div class="container">
    ...
    <div class="card card-login mx-auto mt-5 w-50">
        <h5 class="card-header py-3 ">
            <?= $language->GetVar('login') ?></h5>
        <div class="card-body">
            <form action="/<?= $language->GetLanguage() ?>/login" method="post">
                ...
                <a class="link float-end mt-2"
                   href="/<?= $language->GetLanguage() ?>/register"><?= $language->GetVar('no_account') ?></a>
